import { border, Box, Button, ButtonGroup, Radio } from "@chakra-ui/react";
        ...
        >
          ...
          <ButtonGroup>
            <Button bg="teal.500"
              ...
              _hover={{ bg: "white", color: "teal.500", border: "1px solid", borderColor: "teal.500" }} type="submit">Submit</Button>
